...
> Upstream project: [`GoogleCloudPlatform/scion`](https://github.com/GoogleCloudPlatform/scion)

This repository is maintained as a Chinese-localized edition of Scion. The default README is Chinese (`README.md`), while this file keeps the English README for reference. When upstream usage, installation, feature status, or project notes change, update both README files together so the Chinese edition stays synchronized.
